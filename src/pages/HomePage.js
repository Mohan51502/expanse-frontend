...
useEffect(() => {
  const getAllTransactions = async () => {
    try {
     ...
     setLoading(true)
     const res = await axios.post('https://expense-backend-7cj3.onrender.com/api/v1/transections/get-transection', {
       userid: user._id,
       frequency,
       selectedDate,
       type
...
const handleDelete = async (record) => {
  try {
    ...
    await axios.post('https://expense-backend-7cj3.onrender.com/api/v1/transections/delete-transection', {transactionId:record._id})
    setLoading(false)
...
const handleSubmit = async (values) => {
    try {
      ...
      setLoading(true)
      if(editable) {
        await axios.post('https://expense-backend-7cj3.onrender.com/api/v1/transections/edit-transection', {
          payload:{
            ...values,
            userId: user._id
          },
        ...
        await axios.post('https://expense-backend-7cj3.onrender.com/api/v1/transections/add-transection', {...values,userid:user._id})
      setLoading(false)
